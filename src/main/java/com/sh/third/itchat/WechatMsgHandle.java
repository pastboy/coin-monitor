...
//@Slf4j
//@Component
//public class WechatMsgHandle implements IMsgHandlerFace {
//
//    @Override
...
//        String picPath = "D://wechat" + File.separator + fileName + ".jpg"; // 调用此方法来保存图片
...
//        String voicePath = "D://wechat" + File.separator + fileName + ".mp3";
...
//        String fileName = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(new Date());
//        String viedoPath = "D://wechat" + File.separator + fileName + ".mp4";
